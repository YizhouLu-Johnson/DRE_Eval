...
from train_dv_10d_tailored import DVNet
from train_nwj_10d_tailored import NWJNet, QuadraticNWJNet
...
def parse_args():
    ...
    parser.add_argument(
        "--save_plot",
        type=str,
        default="results/kl40/bdre_dv_nwj.png",
        help="Path (relative to repo root) to save the primary plot.",
    )
    parser.add_argument(
        "--save_plot_zoom",
        type=str,
        default="results/kl40/bdre_dv_nwj_zoom.png",
        help="Where to save the zoomed plot (n>=1000). Leave empty to skip.",
    )
    parser.add_argument(
        "--save_plot_pdf",
        type=str,
        default="results/kl40/bdre_dv_nwj.pdf",
        help="Path to save the primary plot as PDF.",
    )
    parser.add_argument(
        "--save_plot_zoom_pdf",
        type=str,
        default="results/kl40/bdre_dv_nwj_zoom.pdf",
        help="Path to save the zoomed plot as PDF.",
    )
    parser.add_argument(
        "--save_summary",
        type=str,
        default="results/kl30/bdre_dv_nwj_summary.txt",
